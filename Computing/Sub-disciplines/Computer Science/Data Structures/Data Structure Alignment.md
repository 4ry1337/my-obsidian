**Data structure alignment** is the way [[Data|data]] is arranged and accessed in [[Computer Memory]]. It consists of three separate but related issues: **data alignment**, **data structure padding**, and **packing**.
